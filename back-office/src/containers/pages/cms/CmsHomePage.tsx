...
const FIELD_CONFIG: Record<TabKey, { name: string; label: string; type: 'text' | 'textarea' }[]> = {
  ...
  atouts: [
    ...
    { name: 'subtitle', label: 'Sous-titre', type: 'text' },
    { name: 'items', label: 'Atouts (JSON)', type: 'textarea' },
  ],
  valeurs: [
    { name: 'title', label: 'Titre de la section', type: 'text' },
    { name: 'subtitle', label: 'Sous-titre', type: 'text' },
    { name: 'items', label: 'Valeurs (JSON)', type: 'textarea' },
  ],
  temoignages: [
    { name: 'title', label: 'Titre de la section', type: 'text' },
    { name: 'subtitle', label: 'Sous-titre', type: 'text' },
...
export const CmsHomePage = () => {
  ...
  const { data: contents, isLoading } = usePageContents('home');
  ...
  const onSubmit = (data: Record<string, unknown>) => {
    ...
    upsert.mutate({ page: 'home', section: activeTab, content });
  };
