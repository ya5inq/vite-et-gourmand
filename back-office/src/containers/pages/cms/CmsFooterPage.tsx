...
export const CmsFooterPage = () => {
  const [activeTab, setActiveTab] = useState<TabKey>('horaires');
  const { data: contents, isLoading } = usePageContents('footer');
  ...
  const onSubmit = (data: Record<string, unknown>) => {
    ...
    const jsonFields = ['schedule', 'social_links', 'nav_links'];
    ...
    upsert.mutate({ page: 'footer', section: activeTab, content });
  };

  return (
    <DashboardPageLayout title="CMS - Footer" description="Gestion du contenu du pied de page">
