...
describe('AuthService', () => {
  ...
  const authService = new AuthService(statelessTokenServiceMock, userTokenServiceMock, envConfigMock);
  ...
  describe('generateAccessToken', () => {
    it('should generate an access token', async () => {
      ...
      const result = await authService.generateAccessToken(userId, user);
