...
export const DELIVERY_ZONES: DeliveryZoneFixture[] = [
  ...
  { name: 'Mérignac', postalCode: '33700', city: 'Mérignac', distanceKm: 8, isActive: true },
  ...
  { name: 'Bègles', postalCode: '33130', city: 'Bègles', distanceKm: 5, isActive: true },
